...
###### Live Demo : https://gajjalanaveenreddy.github.io/Resume-Builder/
...
3. `git clone https://github.com/gajjalanaveenreddy/Resume-Builder.git`

To contribute to the project:

1. Choose any open issue from [here](https://github.com/gajjalanaveenreddy/Resume-Builder/issues). 
